...
export default class LineChart extends Component {
  ...
  restoreZoomStep = (zoomIndex: any, ClearZoom?: boolean) => {
    try {
      ...
      this.objChart.restoreZoomStep(zoomIndex, ClearZoom);  //tmp comment prath 17-12-2020 wip
    } catch (error) { }
  };
  ...
  plotChartRegular = () => {
    try {
      ...
      objCustomAxis.StartPos = 100;
      objCustomAxis.EndPos = 200;
      ...
      this.objChart.topAxis().AutoScale = true;
      this.objChart.topAxis().Title = "Top Axis";
      this.objChart.topAxis().LabelAngel = 0;
      this.objChart.topAxis().ShowSelector = false;
      this.objChart.topAxis().ShowTitle = true;
      this.objChart.topAxis().Visible = true;
      this.objChart.topAxis().IsDateTime = false;
      this.objChart.topAxis().TicksCount = 10;
      this.objChart.topAxis().Inverted = false;
      ...
      for (let i = 0; i < 1; i++) {
        ...
        objDataSeries.XAxisId = this.objChart.topAxis().Id;
        if (i % 2 == 0) {
          objDataSeries.YAxisId = this.objChart.leftAxis().Id;// objCustomAxis.Id;
          ...
          objDataSeries.ColorEach = false;  //true original
        } else {

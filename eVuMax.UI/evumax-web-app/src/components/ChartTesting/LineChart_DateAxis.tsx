...
export default class LineChart_DateAxis extends Component {
  ...
  componentDidMount() {
    try {
      ...
      this.objChart.isZoomByRect = true;
  ...
  getFixData = () => {
    try {
      this.objChart.DataSeries.clear();
      let objSeries = new DataSeries();
      objSeries.Id = "series-1"


      objSeries.Stacked = false;
      objSeries.Title = "LineSeries-1";

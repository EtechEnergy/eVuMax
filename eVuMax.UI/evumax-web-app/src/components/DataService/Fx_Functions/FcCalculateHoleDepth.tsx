...
export class CalculateFx {
    SelectionType: string = "0"; //"0": RigState, "1": Hole Depth
...
export default function FcCalculateHoleDepth(_props) {

    let wellID = _props.WellID;

    debugger;

    const [objCalcHoleDepth, setCalcHoleDepth] = useState(new CalculateFx());
    ...
    const startProcess = async () => {
        try {
            ...
            objParameter = new BrokerParameter("selectedval", objCalcHoleDepth.SelectionType);
            objBrokerRequest.Parameters.push(objParameter);

            objParameter = new BrokerParameter("FromDate", utilFunctions.formateDate(objCalcHoleDepth.FromDate));
            objBrokerRequest.Parameters.push(objParameter);

            objParameter = new BrokerParameter("ToDate", utilFunctions.formateDate(objCalcHoleDepth.ToDate));
            objBrokerRequest.Parameters.push(objParameter);
    ...
    return (
        <>
            <Dialog title={"Calculate Hole Depth"}
                width={"700px"}
                height={"400px"}
                onClose={() => {
                    debugger;
                ...
                <div className="row mt-3" >
                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-6 mb-3">
                        ...
                        <RadioButton
                            name="SelectionType"
                            value="0"
                            checked={objCalcHoleDepth.SelectionType == "0"}
                ...
                <div className="row mt-3" >
                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-6 mb-3">
                        ...
                        <RadioButton
                            name="SelectionType"
                            value="1"
                            checked={objCalcHoleDepth.SelectionType == "1"}
                    ...
                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-6 mb-3">
                        <DateTimePicker
                            name="FromDate"
                            value={new Date(objCalcHoleDepth.FromDate)}

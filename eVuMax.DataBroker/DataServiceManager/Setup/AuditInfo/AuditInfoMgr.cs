...
namespace eVuMax.DataBroker.DataServiceManager
{
    ...
    public class AuditInfoMgr : IBroker
    {
        ...
        public BrokerResponse getData(BrokerRequest paramRequest)
        {
            ...
            if (paramRequest.Function == loadData)
            {
                ...
                string strSQL;
                string RefWellID = wellId;
                strSQL = "SELECT CHANGE_DATE,OBJECT_TYPE,OBJECT_ID,FUNCTION_TYPE,CHANGE_INFORMATION,CHANGE_BY, WELL_ID  FROM VMX_DATA_AUDIT WHERE WELL_ID='" + RefWellID + "' ";
